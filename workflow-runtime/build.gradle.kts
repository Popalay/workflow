...
kotlin {
  sourceSets {
    ...
    commonMain {
      dependencies {
        ...
        api(Dependencies2.Kotlin.Stdlib.common)
        api(Dependencies2.Kotlin.Coroutines.coreCommon)
      }
    }

    commonTest {
      dependencies {
        implementation(Dependencies2.Kotlin.Test.common)
        implementation(Dependencies2.Kotlin.Test.annotations)
      }
    }
  }
  ...
  jvm {
    ...
    compilations["test"].defaultSourceSet {
      withJava()
      dependencies {
        implementation(Dependencies2.Kotlin.Test.jdk)
    ...
    compilations["jmh"].defaultSourceSet {
      ...
      dependencies {
        ...
        dependencies.add("jmh", Dependencies2.Kotlin.Stdlib.jdk6)
        dependencies.add("jmh", Dependencies2.Jmh.core)
        dependencies.add("jmh", Dependencies2.Jmh.generator)
      }
    }
  }
}
