...
buildscript {
  dependencies {
    classpath(Dependencies2.android_gradle_plugin)
    classpath(Dependencies2.detekt)
    classpath(Dependencies2.dokka)
    classpath(Dependencies2.Jmh.gradlePlugin)
    classpath(Dependencies2.Kotlin.binaryCompatibilityValidatorPlugin)
    classpath(Dependencies2.Kotlin.gradlePlugin)
    classpath(Dependencies2.Kotlin.Serialization.gradlePlugin)
    classpath(Dependencies2.ktlint)
    classpath(Dependencies2.mavenPublish)
  }
...
subprojects {
  ...
  afterEvaluate {
    ...
    configurations.configureEach {
      ...
      resolutionStrategy.force(Dependencies2.Kotlin.reflect)
    }
  }
